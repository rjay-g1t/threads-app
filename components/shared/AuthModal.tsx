    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-dark-2 rounded-xl p-8 max-w-md w-full mx-4">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-heading3-bold text-light-1">Authentication Required</h2>
          <button 
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <p className="text-small-regular text-gray-1">
            🔒 We use ClerkJS for authentication - everything is safe and secured!
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <Button 
            ...
            className="bg-primary-500 hover:bg-primary-500/90 text-light-1"
          >
            Create Account
          </Button>
          <Button 
            ...
            variant="outline"
            className="border-dark-4 text-light-1 hover:bg-dark-3"
          >
            Sign In
          </Button>
          <Button 
